...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        ...
        <description>a description has been given</description>
        <field>OwnerId</field>
        <lookupValue>rothermal@unorganzied.com</lookupValue>
    ...
    <tasks>
        ...
        <assignedTo>rothermal@unorganzied.com</assignedTo>
